...
RSpec.describe 'Advanced Nested Collections' do
  ...
  it 'test 7' do
    ...
    # all restaurants
    employee_names = stores.flat_map do |k,v|
      v[:employees]
    end 
  ...
  it 'test 8' do
    ...
    ingredients = stores.flat_map do |k,v|
      v[:dishes].flat_map do |dish|
        dish[:ingredients]
      end 
    end 
  ...
  it 'test 9' do
    ...
    full_menu_price = stores[:olive_garden][:dishes].sum do |k,v| 
      k[:price] 
    end 
